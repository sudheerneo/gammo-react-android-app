        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Test</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>Game</Text>
                </Block>
                <Block row>
                  <Text color="white" size={60}>Challenge</Text>
                  <Block middle style={styles.pro}>
                    <Text size={16} color="white">Beta</Text>
                  </Block>
                </Block>
              </Block>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>FALL BACK</Text>
              </Button>
            </Block>
          </Block>
        </Block>
